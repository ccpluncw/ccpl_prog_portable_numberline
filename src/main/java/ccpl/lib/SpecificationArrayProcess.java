...
public class SpecificationArrayProcess {
  ...
  public SpecificationArrayProcess() {isLocalWriteDir = false;}
  ...
  public boolean writeToURL(URL cgi, URL filename, String outString){
      ...
      if(cgi != null){
        try {
            String message = "out=" + URLEncoder.encode(outString, "UTF-8") + "&file=" + URLEncoder.encode(filename.getPath(), "UTF-8");
