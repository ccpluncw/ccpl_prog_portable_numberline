...
//    private boolean boundToExterior;
    ...
    public NumberLine(int width, int height, int thickness, Unit startU, Unit endU, Unit targetU,
        ...
        sUnitLabelW = 0; sUnitLabelH = 0; eUnitLabelW = 0; eUnitLabelH = 0;
...
//    public void setBoundToExterior(boolean b){
//        boundToExterior = b;
//    }
 ...
 //               robot.mouseMove((int)currentDragPoint.x, (int)currentDragPoint.y);
            } catch (AWTException ex) {Logger.getLogger(NumberLine.class.getName()).log(Level.SEVERE, null, ex);}
        }
    }
 ...
 //                   robot.mouseMove((int)currentDragPoint.x, (int)currentDragPoint.y);
    ...
    public void thisWillBeMouseDraggedWhenIAmFinished(MouseEvent e){
        ...
        if(degreeOfLine == 90 || degreeOfLine == 270) vertical = true;
        else vertical = false;
        
        if(degreeOfLine >= 90 && degreeOfLine < 270) regularX = true;
        else regularX = false;
...
//                targetLoc.y = targetLoc.y + (lengthTU/2);
        ...
        private void displayLabels(Graphics2D g){
            ...
            if(!"none".equals(unitLabel)){
                ...
                else target = target + " " + unitLabel + "s";
            }
